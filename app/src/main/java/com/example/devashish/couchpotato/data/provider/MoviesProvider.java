package com.example.devashish.couchpotato.data.provider;
...
import com.example.devashish.couchpotato.utils.SelectionBuilder;

import java.util.Arrays;

import timber.log.Timber;

import static com.example.devashish.couchpotato.data.provider.MoviesContract.CONTENT_AUTHORITY;
import static com.example.devashish.couchpotato.data.provider.MoviesContract.Genres;
import static com.example.devashish.couchpotato.data.provider.MoviesContract.Movies;
import static com.example.devashish.couchpotato.data.provider.MoviesDatabase.MoviesGenres;
import static com.example.devashish.couchpotato.data.provider.MoviesDatabase.Tables;
